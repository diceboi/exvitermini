          ...
          <div className="container w-10/12 m-auto flex flex-col gap-8 lg:border-x border-[#ffffff80] border-dashed lg:px-8 pb-16">
            <div className="flex flex-col gap-8 lg:gap-16 py-10">
              ...
              <div className="flex flex-col gap-4">
                ...
                We are a small group of professionals with creative mindsets. We can be your company&apos;s universal tool to help you rationalize your new product, create brand, design, product catalogues and publications. We can even help you develop, build and test prototypes with complete documentations, drawings and production plans.
                </p>
                <p className="text-white text-syne text-justify font-medium text-sm lg:text-xl z-50 ">
