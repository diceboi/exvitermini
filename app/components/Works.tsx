    ...
    >
          ...
          <div className="container w-10/12 m-auto flex flex-col gap-8 lg:border-x border-[#ffffff80] border-dashed lg:px-8 pb-16">
            <div className="flex flex-col gap-8 lg:gap-16 py-10 border-b border-white">
              ...
              Well, we do not dance, that&apos;s for sure, but we do have a creative mindset to execute that two steps: think and create something what our customers like. Exvitermini can be your company&apos;s universal tool to help you rationalize your new product, create design, branding, product catalogues and publications. We can even help you to develop, build and test prototypes; organize and create documents, drawings, production plans. We are able to give you precisely defined package of services with transparent processes and organized workflow in order to take off weight from your shoulder. We create the enviroment for you where you can direct your attention to details which are most important to you.
              </p>
            </div>
